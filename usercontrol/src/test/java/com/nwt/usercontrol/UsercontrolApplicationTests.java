...
class UsercontrolApplicationTests {
    ...
    public void post_VALID() throws Exception{
        ...
        // sad cemo provjeriti jel zaista dodan u bazu

        mockMvc.perform(MockMvcRequestBuilders.get("/api/users")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.jsonPath("$", hasSize(3))) // da li su vracena 3 objekta
                .andExpect(status().isOk());
    }
    ...
    public void delete_VALID() throws Exception{
        ...
        // hajmo vidjeti jel mu atribut obrisan postavljen na 1

        mockMvc.perform(MockMvcRequestBuilders.get("/api/users/1")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.obrisan", Matchers.is(1)));
    }
    ...
    /*
    *  NAPOMENA
    *  za naredna 2 testa je potrebno pokrenuti i discovery service, kao i billings service
    *
    * */
